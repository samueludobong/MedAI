...
class micai(QMainWindow):
    def __init__(self):
        ...
        relative_path = os.path.join(dir, "../ui/medui.ui")
    ...
    def train_model(self):
        data = pd.read_csv(os.path.join(dir, "../scripts/diseases.csv"))
    ...
    def setupui(self):
        self.label.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/fever.png")))
        self.label_38.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/m_ai__1_-removebg-preview.png")))
        self.label_45.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/m_ai__1_-removebg-preview.png")))
        self.label_46.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/m_ai__1_-removebg-preview.png")))
        self.label_12.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/cough.png")))
        self.label_16.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/tiredness.png")))
        self.label_20.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/difficulty-breathing.png")))
        self.label_24.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/calendar.png")))
        self.label_28.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/lavatory.png")))
        self.label_32.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/blood-pressure.png")))
        self.label_36.setPixmap(
            QtGui.QPixmap(os.path.join(dir, "../ui/cholesterol.png")))
        icon = QIcon(os.path.join(dir, "../ui/quiz.png"))
        self.start.setIcon(icon)
        icon2 = QIcon(os.path.join(dir, "../ui/file-medical-alt.png"))
